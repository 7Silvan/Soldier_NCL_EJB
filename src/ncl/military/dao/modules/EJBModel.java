...
import ncl.military.dao.ejb.LocationHome;
import ncl.military.dao.ejb.SoldierHome;
import ncl.military.dao.ejb.UnitHome;
...
public class EJBModel {
    ...
    private UnitHome unitHome;
    private SoldierHome soldierHome;
...
// values to take // soldier_id // soldier_name // soldier_rank // soldier_commander // unit_name // soldier_birthdate
    ...
    public void init(Map<String, String> initParams) {
        try {
            ...
            locationObject = context.lookup(initParams.get("jndiLocation"));
            unitObject = context.lookup(initParams.get("jndiUnit"));
            soldierObject = context.lookup(initParams.get("jndiSoldier"));
            locationHome = (LocationHome) PortableRemoteObject.narrow(locationObject, LocationHome.class);
            unitHome = (UnitHome) PortableRemoteObject.narrow(unitObject, UnitHome.class);
            soldierHome = (SoldierHome) PortableRemoteObject.narrow(soldierObject, SoldierHome.class);
